...
def delete_customers_cases_params():
    ...
    """
    return [
        pytest.param({"id": "USE_CREATED?force=true"}, 200, marks=pytest.mark.positive, id="delete_existing_force_true"),
        pytest.param({"id": "USE_CREATED"}, 501, marks=pytest.mark.positive, id="delete_existing_no_force"),
        ...
        pytest.param({"id": ""}, 404, marks=pytest.mark.negative, id="delete_empty_id"),
